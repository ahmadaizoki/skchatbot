...
if (!config.APIAI_ACCESS_TOKEN) {
	throw new Error('missing APIAI_ACCESS_TOKEN');
}
if (!config.APP_ID) {
...
const apiAiService = apiai(config.APIAI_ACCESS_TOKEN, {
	language: "fr",
	requestSource: "skype"
});
...
app.get('/webhook/', function (req, res) {
	console.log("request");
	if (req.query['hub.mode'] === 'subscribe' && req.query['hub.verify_token'] === config.APP_SECRET) {
